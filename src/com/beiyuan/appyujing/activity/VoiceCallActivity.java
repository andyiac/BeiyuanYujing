...
public class VoiceCallActivity extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		callListview = (ListView) findViewById(R.id.call_listview);

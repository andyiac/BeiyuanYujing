...
public class RegisterFinish extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				switch (msg.what) {
				case 1:
					Toast.makeText(RegisterFinish.this, "注册成功", Toast.LENGTH_SHORT)
							.show();
					break;
				case 2:
					Toast.makeText(RegisterFinish.this, "昵称有重复", Toast.LENGTH_SHORT)
					.show();
				case 3:
					Toast.makeText(RegisterFinish.this, "注册失败", Toast.LENGTH_SHORT)
					.show();
				}
			}
		};
	...
	private class StudentRightListener implements OnRightButtonClickListener {
		...
		public void onClick(View button) {
			...
			String studentProfession = professionCheck();
			String studentClass = classCheck();
...
//											+ strLoginRst.equals("success"));
	...
	public void showCollegeDialog() {
		...
		listView_college.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				showTeacherGradeDialog(); // 教师的年级多选对话框
	...
	public void showClassesDialog(int id) {
		...
		// 设置对话框的宽高
		LayoutParams layoutParams = new LayoutParams(width * 90 / 100, 400);
		builder.setContentView(viewDialog, layoutParams);
	...
	public void showTeacherGradeDialog() {
		builder = new Dialog(this);
		builder.setTitle("年级多选");
		builder.show();

		LayoutInflater inflater = LayoutInflater.from(this);
		View viewDialog = inflater.inflate(R.layout.teacher_listview_grade,
				null);
		Button btnsure = (Button) viewDialog.findViewById(R.id.check_sure);
		Button btncancle = (Button) viewDialog.findViewById(R.id.check_cancle);
		Display display = this.getWindowManager().getDefaultDisplay();
		Point size = new Point();
		display.getSize(size);
		int width = size.x;
		...
		ListView listView_class = (ListView) viewDialog
				.findViewById(R.id.teacher_grade);
		...
		SimpleAdapter adapterClass = new SimpleAdapter(this,

		data, R.layout.teacher_grade_item, new String[] { "name",
	...
	// 教师专业多选对话框
	@SuppressLint("NewApi")
	public void showTeacherProfessionDialog() {
		builder = new Dialog(this);
		builder.setTitle("年级多选");
		builder.show();
